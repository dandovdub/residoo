...
- wall time: 2544ms (offline mode)
- egress (scan-time only), offline mode (scored for recall): **none-observed** (0 proxy CONNECT attempt(s), 0 non-proxy socket(s))
- egress (scan-time only), default mode (network verification enabled): **attempted** (24 proxy CONNECT attempt(s), 0 non-proxy socket(s); CONNECT targets: sts.amazonaws.com:443, slack.com:443)
...
- wall time: 3574ms (offline mode)
- egress (scan-time only), offline mode (scored for recall): **none-observed** (0 proxy CONNECT attempt(s), 0 non-proxy socket(s))
- egress (scan-time only), default mode (validation enabled): **attempted** (49 proxy CONNECT attempt(s), 0 non-proxy socket(s); CONNECT targets: api.github.com:443, gitlab.com:443, api.anthropic.com:443, registry.npmjs.org:443, sts.us-east-1.amazonaws.com:443)
...
- wall time: 1079ms (offline mode)
- egress (scan-time only), offline mode (scored for recall): **none-observed** (0 proxy CONNECT attempt(s), 0 non-proxy socket(s))
- egress (scan-time only), default mode (verification enabled): **attempted** (62 proxy CONNECT attempt(s), 4 non-proxy socket(s); CONNECT targets: oss.trufflehog.org:443, slack.com:443, sts.us-east-1.amazonaws.com:443, registry.npmjs.org:443, gitlab.com:443, api.anthropic.com:443, api.github.com:443, keychecker.trufflesecurity.com:443)
