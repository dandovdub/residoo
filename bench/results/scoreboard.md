...
- wall time: 1119ms (offline mode)
- egress (scan-time only), offline mode (scored for recall): **none-observed** (0 proxy CONNECT attempt(s), 0 non-proxy socket(s))
- egress (scan-time only), default mode (verification enabled): **attempted** (48 proxy CONNECT attempt(s), 0 non-proxy socket(s); CONNECT targets: oss.trufflehog.org:443, slack.com:443, gitlab.com:443, registry.npmjs.org:443, api.anthropic.com:443, api.github.com:443)
